...
namespace G_Pro_Try
{
    public partial class frmChange_Password_Doc : Form
    {
        DBConnect dBCon = new DBConnect();
        
        public frmChange_Password_Doc()
        {
            InitializeComponent();
        }
        ...
        {
            frmChange_Password ch = new frmChange_Password();
            ch.Show();
            this.Hide();
        }
        ...
        private void txtCurrentPassword_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter adapter = new SqlDataAdapter("SELECT COUNT(*) FROM Doctor WHERE DoctorName = '" + txtUserName.Text + "' AND DoctorPassword = '" + txtCurrentPassword.Text + "' ", Connection);
            ...
            if (table.Rows[0][0].ToString() == "1")
            {
                if (txtNewPassword.Text==txtConfirmPassword.Text)
                {
                    ...
                    {
                        SqlDataAdapter cc = new SqlDataAdapter("UPDATE Doctor SET DoctorPassword = '" + txtNewPassword.Text + "' WHERE DoctorName = '" + txtUserName.Text + "' AND DoctorPassword = '" + txtCurrentPassword.Text + "'  ", Connection);
        ...
        private void frmChange_Password_Doc_Load(object sender, EventArgs e)
        {
